...
import { FaFacebook, FaLinkedin, FaMedium, FaGithub } from "react-icons/fa";
      ...
      <div className="container mx-auto px-8 md:px-16 lg:px-24">
        <div className='flex flex-col md:flex-row md:space-x-12 items-center mb-4'>
          <div className='flex-1 mb-4 md:mb-0'>
            <h3 className='text-2xl font-bold mb-2'>Muhammed Salih</h3>
            <p className='text-gray-400'>
              Full-Stack Developer based in India, specializing in web and software development
            </p>
            <p className='text-gray-400'>Email: muhammadsalih563@example.com</p>
            <p className='text-gray-400'>Phone: +91-9947038609</p> {/* Replace with your phone number */}
          </div>
        </div>
